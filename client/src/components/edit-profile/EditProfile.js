            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Please use a comma to separate values (eg. HTML,CSS,Javascript,PHP)"
                />
                <TextFieldGroup
                  ...
                  info="If you want to link your latest repos and a Github link, include your username"
                />
                <TextAreaFieldGroup
